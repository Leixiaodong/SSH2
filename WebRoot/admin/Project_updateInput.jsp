...
<link rel="stylesheet" href="/SSH5/css/common.css" type="text/css"></link>
  ...
  <body>
   ...
   <form method="post" action="<%=basePath%>admin/Project_update.action" target="_self">
     <table width="80%" height="200" border="1" align="center"
					...
					<tr>
						<td height="31" colspan="2" align="center" bgcolor="#6A82DA">
							<span class="span3">修改项目信息</span></td>
					</tr>
                    	<tr>
							...
							<td bgcolor="#F1F3F5">
								<input name="project.id" type="text" id="textfield4"
									value="${project.id}" size="38">
							</td>
						</tr>
					<tr>
					...
					<tr>
						...
						<td valign="top" bgcolor="#F1F3F5">
							<p>
								<textarea name="project.proinfo" cols="70" rows="10">${project.proinfo}</textarea>
							</p>
						</td>
					</tr>
					<tr>
						...
						<td bgcolor="#E4EDF9">
							<input name="project.time" type="text" id="textfield4" value="${project.time}"
								size="38">
						</td>
					</tr>
					<tr>
							...
							<td bgcolor="#F1F3F5">
								<input name="project.teacher.id" type="text" id="textfield4"
									value="${project.teacher.id}" size="38">
							</td>
						</tr>
						<tr>
