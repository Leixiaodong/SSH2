...
<link rel="stylesheet" href="/SSH5/css/common.css" type="text/css"></link>
  ...
  <body>
   ...
   <div class="main1">
	  ...
	  <form method="post" action="<%=basePath%>admin/Student_update.action"
				target="_self">
				...
				<table class="list_tab" align="center" width="80%" cellspacing="1"
					...
					<tr>
						...
						<td width="72%" bgcolor="#F1F3F5">
							<input name="student.id" type="text" id="textfield6"
								value="${student.id}" size="38">
						</td>
					</tr>
                    ...
                    <tr>
						...
						<td width="72%" bgcolor="#E4EDF9">
							<input name="student.name" type="text" id="textfield6" value="${student.name}"
								size="38">
						</td>
					</tr>
					<tr>
