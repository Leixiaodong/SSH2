...
<html>
	...
	<div class="span1">
		...
		<div class="main1">
		      	...
		      	<form method="post" action="<%=basePath%>admin/User_update.action"
				target="_self">
				<table width="80%" height="118" border="1" align="center"
					...
					<tr>
						<td height="31" colspan="2" align="center" bgcolor="#6A82DA">
							<span class="span3">修改普通用户</span>
						</td>
					</tr>
                    <tr>
						<td height="24" align="right" valign="middle" bgcolor="#F1F3F5">
							<span class="span3">用户编号</span>：
						</td>
						<td height="24" align="left" valign="top" bgcolor="#F1F3F5">
							<input name="user.id" type="text" id="textfield8"
								value="${user.id}" size="38">
						</td>
					</tr>
					<tr>
						<td width="26%" height="31" align="right" bgcolor="#E4EDF9">
							<span class="span3">用户名称：</span>
						</td>
						<td width="74%" align="left" bgcolor="#E4EDF9">
							<input name="user.name" type="text" id="textfield7" value="${teacher.name}"
								size="38">
						</td>
					</tr>
					<tr>
						...
						<td height="24" align="left" valign="top" bgcolor="#F1F3F5">
							<input name="user.password" type="text" id="textfield8"
								value="${teacher.password}" size="38">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td bgcolor="#F1F3F5">
							<input name="user.email" type="text" id="textfield9" value="${teacher.email}"
								size="38">
						</td>
					</tr>
					<tr>
