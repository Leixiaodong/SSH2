...
<link rel="stylesheet" href="/SSH5/css/common.css" type="text/css"></link>
  ...
  <body>
   ...
   <div class="main1">
	       ...
	       <form method="post" action="<%=basePath%>admin/Teacher_update.action"
				target="_self">
				...
				<table class="list_tab" align="center" width="80%" cellspacing="1"
					...
					<tr>
						...
						<td width="72%" bgcolor="#F1F3F5">
							<input name="teacher.id" type="text" id="textfield6"
								value="${teacher.id}" size="38">
						</td>
					</tr>
                    ...
                    <tr>
						...
						<td width="72%" bgcolor="#E4EDF9">
							<input name="teacher.name" type="text" id="textfield6" value="${teacher.name }"
								size="38">
						</td>
					</tr>
					<tr>
						...
						<td width="72%" bgcolor="#F1F3F5">
							<input name="teacher.password" type="text" id="textfield6"
								value="${teacher.name }" size="38">
						</td>
					</tr>
					<tr>
                      ...
                      <tr>
				    <td align="right" bgcolor="#F1F3F5">简介：</td>
				    <td colspan="2" bgcolor="#F1F3F5"><textarea name="teacher.info" cols="70" rows="10">${teacher.info }</textarea></td>
			      </tr>
                    <tr>
				    <td align="right" bgcolor="#E4EDF9">职称：</td>
				    <td colspan="2" bgcolor="#E4EDF9"><input name="teacher.zhicheng" type="text" id="textfield5"
								value="${teacher.zhicheng }" size="38"></td>
			      </tr>
					...
					<tr>
						<td height="23" align="right" bgcolor="#F1F3F5">&nbsp;
							
						</td>
						<td height="23" align="right" bgcolor="#F1F3F5">&nbsp;</td>
					</tr>
					<tr>
